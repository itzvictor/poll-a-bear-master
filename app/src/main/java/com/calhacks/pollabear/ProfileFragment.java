...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        UserModel user = PollApplication.loggedInUser;
        TextView title = (TextView) vi.findViewById(R.id.textView2);
        ...
        fbProfilePicture.setProfileId(PollApplication.loggedInUser.getFbId());
